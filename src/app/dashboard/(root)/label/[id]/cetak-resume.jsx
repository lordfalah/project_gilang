        ...
        <div className="flex justify-between">
          <div className="space-y-3.5">
            <h2 className="text-2xl font-semibold">
              PEMERINTAH KABUPATEN SINTANG DINAS KESEHATAN UPTD PUSKESMAS SEPAUK
            </h2>
            <div>
              <p>Jl. Manunggal AMD XXXIV,</p>
              <p>Tanjung Ria, Kec. Sepauk 78662, Kalimantan Barat</p>
              <p>Kab. Sintang, Kalimantan Barat</p>
              <p>-</p>
            </div>
          </div>
          <Image
            src={"/image/logo/puskesmas.png"}
            width={200}
            height={200}
            priority
            className="w-20 aspect-square"
            style={{ objectFit: "contain", backgroundBlendMode: "color-burn" }}
          />
        </div>
        ...
        <article className="mt-20 mb-16">
          ...
          <div className="grid grid-cols-2 mt-16 gap-y-8 text-lg">
            ...
            <div className="col-span-2 xl:col-span-1 ">
              ...
              <div className="flex">
                <p className="basis-1/2">Hasil Pemeriksaan</p>
